...
import { Card } from 'ui-components/card/Card'; import { classNames } from 'utils/classNames'
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex items-center">
                      <CalculatorIcon className="h-8 w-8 mr-2 text-indigo-300"></CalculatorIcon>
                      <b><p className='text-indigo-200'>PayPals</p></b>
                    </div>
