...
export const LabeledAmountInput = ({ id, label, onChange }) => {
  return (
    <div className='flex flex-col mb-5'>
      ...
      <div className="relative mt-2 rounded-md shadow-sm">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center">
          ...
          <select id="currency" name="currency" className="h-full rounded-md border-0 bg-transparent py-0 pl-2 pr-7 text-gray-500 sm:text-sm">
            <option>ARS</option>
            <option>USD</option>
            <option>CAD</option>
            <option>EUR</option>
